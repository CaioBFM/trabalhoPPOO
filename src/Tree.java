...
public class Tree extends Actor
{
    ...
    // Árvores estão sempre vivas na simulação atual (a menos que sejam destruídas, o que não foi especificado).
     ...
     * Como é um ator estático, ela deve se manter na mesma posição no campo atualizado.
     */
